    ...
    <?php $i+=1;?>
                                <div class="col-md-4">
                                    <div class="staff-item">
                                        <a href="{{  route('profileclans', $id=$q->clan_id) }}">
                                            <span class="info">
                                                <span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{$q->clan_name}} </font></font></span>
                                                <span class="position"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">CLAN TOP &nbsp;{{$i}}</font></font></span>
